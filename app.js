...
function render(){
  ...
  if(tab==='home'){
    ...
    c.innerHTML+=`<div class='card'><h2>Join Competition</h2><p>New player? Register your name and create a 4-digit PIN.</p><button class='primary' id='joinBtn'>Join Competition</button></div>`;
